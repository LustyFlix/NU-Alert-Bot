...
def request_time(client: Client, get_tree={}):
    ...
    tabs = ['//*[@id="section1"]/div/div/div', '//*[@id="section-3"]/div/div/div/div', '//*[@id="section-4"]/div/div/div', '//*[@id="section-6"]/div/div/div']
...
def notice_link(tab_iterator, notice_iterator, tree):
    try:
        ...
        sendtelegram(2, AUTH_CHANNEL, '_', 'Got an error finding the notice link, tab {} notice {}.'.format())
